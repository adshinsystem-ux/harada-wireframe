...
export function JobRequirementsTechnical() {
  return (
              ...
              <div className="border-2 border-gray-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 border-b-2 border-gray-300">
                  ...
                  <div className="md:col-span-2 p-4 md:p-6">
                    <p style={{ fontSize: 'clamp(14px, 2vw, 16px)', lineHeight: '1.8' }}>技術職</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 border-b-2 border-gray-300">
                  ...
                  <div className="md:col-span-2 p-4 md:p-6">
                    <p style={{ fontSize: 'clamp(14px, 2vw, 16px)', lineHeight: '1.8' }}>
                      生コンクリートの品質管理、配合設計、試験業務を担当します。製品の品質を守り、お客様に安心・安全な製品を提供する重要な役割です。
                    </p>
                  </div>
                </div>
